...
::: info
This page documents the **Input #** *statement*. The unrelated [**Input** function](/en/official/Reference/VBA/FileSystem/Input) reads a fixed number of characters from any open file.
:::
