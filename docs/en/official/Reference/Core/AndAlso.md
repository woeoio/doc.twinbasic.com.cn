...
::: info
**AndAlso** is a twinBASIC extension. The classic [**And**](/en/official/Reference/Core/And) operator always evaluates both operands and returns a bitwise result; **AndAlso** evaluates the right operand only when needed and always returns a **Boolean**.
:::
