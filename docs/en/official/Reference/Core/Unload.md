...
When an object is unloaded, it is removed from memory and all memory associated with the object is reclaimed. Until it is placed in memory again with the [**Load**](/en/official/Reference/Core/Load) statement, the user can't interact with the object, and the object can't be manipulated programmatically.
...
- [**Load** statement](/en/official/Reference/Core/Load)
