...
Use [**Unload**](/en/official/Reference/Core/Unload) to remove the object from memory once it is no longer needed.
...
- [**Unload** statement](/en/official/Reference/Core/Unload)
