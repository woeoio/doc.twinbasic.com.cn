...
::: info
**OrElse** is a twinBASIC extension. The classic [**Or**](/en/official/Reference/Core/Or) operator always evaluates both operands and returns a bitwise result; **OrElse** evaluates the right operand only when needed and always returns a **Boolean**.
:::
