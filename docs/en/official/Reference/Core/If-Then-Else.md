...
::: tip
[**Select Case**](/en/official/Reference/Core/Select-Case) may be more useful when evaluating a single expression that has several possible actions. However, the **TypeOf** *objectname* **Is** *objecttype* clause can't be used with the **Select Case** statement.
:::
...
- [**#If...Then...Else** directive](/en/official/Reference/Core/Topic-Preprocessor)
