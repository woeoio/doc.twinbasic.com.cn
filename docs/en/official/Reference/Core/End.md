...
- **End**  
  Terminates execution immediately. Never required by itself but may be placed anywhere in a procedure to end code execution, close files opened with the [**Open**](/en/official/Reference/Core/Open) statement, and to clear variables.
...
- **End Sub**
  Required to end a [**Sub**](/en/official/Reference/Core/Sub) statement.

- **End Type**
  Required to end a user-defined type (UDT) definition ([**Type**](/en/official/Reference/Core/Type) statement).

- **End With**
  Required to end a [**With**](/en/official/Reference/Core/With) statement.
