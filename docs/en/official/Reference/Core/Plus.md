...
When the **+** operator is used, it may not be obvious whether addition or string concatenation will occur. Use the [**&**](/en/official/Reference/Core/Concat) operator for concatenation to eliminate ambiguity and produce self-documenting code.
...
This example uses the **+** operator to sum numbers. The **+** operator can also be used to concatenate strings, but to eliminate ambiguity use the [**&**](/en/official/Reference/Core/Concat) operator instead.
...
- [**-** operator](/en/official/Reference/Core/Minus)
- [**&** operator](/en/official/Reference/Core/Concat)
- [**\*** operator](/en/official/Reference/Core/Multiply)
