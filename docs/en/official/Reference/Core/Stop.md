...
The **Stop** statement suspends execution, but unlike [**End**](/en/official/Reference/Core/End), it doesn't close any files or clear variables, unless it is in a compiled executable (.exe) file.
...
- [**End** statement](/en/official/Reference/Core/End)
