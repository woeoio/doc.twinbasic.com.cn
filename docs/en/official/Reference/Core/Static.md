...
By convention, **Static** statements within a procedure are placed at the beginning of the procedure with other declarative statements such as **[Dim](/en/official/Reference/Core/Dim)**.
