...
::: info
The [**Is**](/en/official/Reference/Core/Is) and [**Like**](/en/official/Reference/Core/Like) operators have their own dedicated comparison semantics and are documented separately.
:::
...
String comparisons are governed by the module's [**Option Compare**](/en/official/Reference/Core/Option) setting --- **Binary** (the default; case-sensitive, ordinal) or **Text** (case-insensitive, locale-sensitive).
...
- [**Is** operator](/en/official/Reference/Core/Is)
- [**IsNot** operator](/en/official/Reference/Core/IsNot)
- [**Like** operator](/en/official/Reference/Core/Like)
