...
- [Comparison operators](/en/official/Reference/Core/Comparison-Operators)
- [**Option** statement](/en/official/Reference/Core/Option)
- [**InStr** function](/en/official/Reference/VBA/Strings/InStr)
