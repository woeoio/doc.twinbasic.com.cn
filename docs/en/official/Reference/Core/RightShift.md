...
::: info
**\>>** and **\>>=** are twinBASIC extensions. Classic VBA has no bitshift operators; equivalent code divides by powers of two with [**\\\\**](/en/official/Reference/Core/IntegerDivide) (`x \ 2`, `x \ 4`, …).
:::
...
- [**\<<** operator](/en/official/Reference/Core/LeftShift)
