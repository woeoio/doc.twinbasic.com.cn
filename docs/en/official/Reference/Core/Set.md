...
**[New](/en/official/Reference/Core/New)**
...
The [**Dim**](/en/official/Reference/Core/Dim), [**Private**](/en/official/Reference/Core/Private), [**Public**](/en/official/Reference/Core/Public), [**ReDim**](/en/official/Reference/Core/ReDim), and [**Static**](/en/official/Reference/Core/Static) statements only declare a variable that refers to an object. No actual object is referred to until the **Set** statement assigns a specific object.
...
- [**New** keyword](/en/official/Reference/Core/New)
