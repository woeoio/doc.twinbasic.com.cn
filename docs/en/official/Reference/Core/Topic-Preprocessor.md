...
The directive's behaviour mirrors the runtime [**If...Then...Else**](/en/official/Reference/Core/If-Then-Else) statement, with the following differences:
...
::: info
The [**Option Compare**](/en/official/Reference/Core/Option) statement does not affect expressions in `#If`/`#ElseIf`. They are always evaluated as if **Option Compare Text** were in effect.
:::
...
*expression*
: A literal, another conditional compiler constant, or any combination using arithmetic or logical operators (except [**Is**](/en/official/Reference/Core/Is)). Standard runtime constants (declared with [**Const**](/en/official/Reference/Core/Const)) are *not* allowed here.
...
twinBASIC provides a set of built-in compiler constants --- `Win64`, `Win32`, `TWINBASIC`, `TWINBASIC_BUILD`, `VBA7`, etc. See the dedicated [Compiler Constants](/en/official/Reference/Compiler-Constants) page for the full list and what each one means.
...
- [**If...Then...Else** statement](/en/official/Reference/Core/If-Then-Else) -- the runtime counterpart.
- [**Const** statement](/en/official/Reference/Core/Const) -- the runtime counterpart of **#Const**.
- [Compiler Constants](/en/official/Reference/Compiler-Constants) -- the full list of built-in conditional constants.
