...
Data written with **Print #** is usually read from a file with [**Line Input #**](/en/official/Reference/Core/Line-Input) or [**Input #**](/en/official/Reference/Core/Input).
