...
Returns a [**WebView2HeadersCollection**](/en/official/Reference/WebView2/WebView2HeadersCollection) iterator restricted to the headers that match *name*.
...
See [**WebView2HeadersCollection**](/en/official/Reference/WebView2/WebView2HeadersCollection) for the iteration object.
