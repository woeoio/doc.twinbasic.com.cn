...
The response's HTTP headers as a [**WebView2ResponseHeaders**](/en/official/Reference/WebView2/WebView2ResponseHeaders) collection --- add or inspect headers here. Read-only at the property level (the collection itself is mutable).
