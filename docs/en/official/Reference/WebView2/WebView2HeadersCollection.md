...
An enumerator that yields [**WebView2Header**](/en/official/Reference/WebView2/WebView2Header) values one by one. Returned by **WebView2RequestHeaders.GetHeaders**, **WebView2ResponseHeaders.GetHeaders**, and by `For Each` over a [**WebView2RequestHeaders**](/en/official/Reference/WebView2/WebView2RequestHeaders) or [**WebView2ResponseHeaders**](/en/official/Reference/WebView2/WebView2ResponseHeaders) instance.
