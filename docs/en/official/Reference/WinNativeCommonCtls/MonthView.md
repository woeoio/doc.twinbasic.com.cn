...
How the control's border is drawn. A [**AppearanceConstants**](/en/official/Reference/VBRUN/Constants/AppearanceConstants) member: **vbAppearFlat** or **vbAppear3d**. Default: **vbAppear3d**. Inherited.
...
The control's border style. A [**ControlBorderStyleConstants**](/en/official/Reference/VBRUN/Constants/ControlBorderStyleConstants) member: **vbNoBorder** or **vbFixedSingleBorder**. Default: **vbFixedSingleBorder**.
...
The day-of-week the current [**Value**](#value) falls on, as a [**VbDayOfWeek**](/en/official/Reference/VBA/Constants/VbDayOfWeek) member. Read-only.
...
Which day of the week is rendered as the leftmost column. A [**VbDayOfWeek**](/en/official/Reference/VBA/Constants/VbDayOfWeek) member. Defaults to the system's first-day-of-week setting.
...
- [DTPicker](/en/official/Reference/WinNativeCommonCtls/DTPicker) -- the inline date picker whose dropdown uses the same Win32 calendar control
- [ControlTypeConstants](/en/official/Reference/VBRUN/Constants/ControlTypeConstants) -- where **vbMonthView** lives
