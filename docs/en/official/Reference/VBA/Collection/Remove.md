...
*index*
: *required* An expression that specifies the member of the collection to remove. If a numeric expression, *index* must be a number from 1 to the value of the collection's [**Count**](/en/official/Reference/VBA/Collection/Count) property. If a string expression, *index* must correspond to the *key* argument specified when the member was added to the collection.
...
To clear a collection in a single call, use the [**Clear**](/en/official/Reference/VBA/Collection/Clear) method instead.

### See Also

- [Add](/en/official/Reference/VBA/Collection/Add) method
- [Clear](/en/official/Reference/VBA/Collection/Clear) method
