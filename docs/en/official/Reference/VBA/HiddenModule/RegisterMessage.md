...
*hook*
: *required* An [**IGetMessageHook**](./#igetmessagehook-interface) instance, typically returned by [**RuntimeCreateGetMessageHook**](/en/official/Reference/VBA/HiddenModule/RuntimeCreateGetMessageHook).
...
The subscription is recorded but does not start firing until [**Start**](/en/official/Reference/VBA/HiddenModule/Start) is called on the hook. Existing subscriptions are not disturbed by adding new ones.
