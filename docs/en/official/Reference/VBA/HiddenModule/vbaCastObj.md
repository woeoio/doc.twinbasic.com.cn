...
Syntax: **vbaCastObj(** _Obj_ **,** _IID_ **)** **As IUnknown**

_Obj_
: _required_ **stdole.IUnknown**. The object to cast.

_IID_
: _required_ **Any**. The interface ID to query for --- accepted as a 16-byte **GUID** structure or as a **String** in registry format (`{xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx}`).
...
- [CreateGUID](/en/official/Reference/VBA/HiddenModule/CreateGUID) function
