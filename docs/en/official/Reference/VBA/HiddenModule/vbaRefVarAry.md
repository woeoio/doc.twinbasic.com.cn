...
Syntax: **vbaRefVarAry(** _Variant_ **)** **As LongPtr**

_Variant_
: _required_ A **Variant** that contains an array, passed by reference.
...
If _Variant_ does not contain an array, the result is undefined.
