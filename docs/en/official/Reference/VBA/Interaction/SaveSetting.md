...
The following example first uses the **SaveSetting** statement to make entries in the Windows registry for the application, and then uses the [**DeleteSetting**](/en/official/Reference/VBA/Interaction/DeleteSetting) statement to remove them.
