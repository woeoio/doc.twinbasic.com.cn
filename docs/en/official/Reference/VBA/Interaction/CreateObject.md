...
::: info
**CreateObject** obtains a new instance of the object. [**GetObject**](/en/official/Reference/VBA/Interaction/GetObject) attaches to an *already-running* instance --- or starts the object's application with a particular file loaded.
:::
...
- [GetObject](/en/official/Reference/VBA/Interaction/GetObject) function
