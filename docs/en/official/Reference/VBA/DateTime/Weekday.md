...
If the [**Calendar**](/en/official/Reference/VBA/DateTime/Calendar) property setting is Gregorian, the returned integer represents the Gregorian day of the week for the date argument. If the calendar is Hijri, the returned integer represents the Hijri day of the week for the date argument.
...
- [Day](/en/official/Reference/VBA/DateTime/Day), [Month](/en/official/Reference/VBA/DateTime/Month), [Year](/en/official/Reference/VBA/DateTime/Year) functions
