...
If the [**Calendar**](/en/official/Reference/VBA/DateTime/Calendar) property setting is Gregorian, the supplied date must be Gregorian. If the calendar is Hijri, the supplied date must be Hijri. The returned date part is in the time period units of the current calendar.
...
- [DateAdd](/en/official/Reference/VBA/DateTime/DateAdd), [DateDiff](/en/official/Reference/VBA/DateTime/DateDiff) functions
