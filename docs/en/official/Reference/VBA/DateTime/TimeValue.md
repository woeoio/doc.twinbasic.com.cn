...
Valid times can be entered using a 12-hour or 24-hour clock. For example, `"2:24PM"` and `"14:24"` are both valid *time* arguments.
...
- [TimeSerial](/en/official/Reference/VBA/DateTime/TimeSerial) function
