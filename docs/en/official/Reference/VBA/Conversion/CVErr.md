...
Note that implicit conversion of an **Error** is not allowed. For example, the return value of **CVErr** cannot be directly assigned to a variable that is not a **Variant**. An explicit conversion (using [**CInt**](/en/official/Reference/VBA/Conversion/CInt), [**CDbl**](/en/official/Reference/VBA/Conversion/CDbl), and so on) of the value returned by **CVErr** can be assigned to a variable of the appropriate data type.
...
- [Error](/en/official/Reference/VBA/Conversion/Error) function
