...
**CDec** is the internationally aware alternative to [**Val**](/en/official/Reference/VBA/Conversion/Val) for converting a string to a numeric type.
...
- [CCur](/en/official/Reference/VBA/Conversion/CCur), [CDbl](/en/official/Reference/VBA/Conversion/CDbl), [CSng](/en/official/Reference/VBA/Conversion/CSng), [ValDec](/en/official/Reference/VBA/Conversion/ValDec) functions
