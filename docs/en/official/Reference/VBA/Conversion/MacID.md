...
Used on the Macintosh to convert a 4-character constant to a value that may be used by [**Dir**](/en/official/Reference/VBA/FileSystem/Dir), [**Kill**](/en/official/Reference/VBA/FileSystem/Kill), **Shell**, and [**AppActivate**](/en/official/Reference/VBA/Interaction/AppActivate).
