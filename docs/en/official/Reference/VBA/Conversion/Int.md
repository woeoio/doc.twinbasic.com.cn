...
::: info
The closely related [**Fix**](/en/official/Reference/VBA/Conversion/Fix) function truncates toward zero rather than rounding toward negative infinity. For positive numbers the two are identical; for negative numbers they differ.
:::
...
- [Fix](/en/official/Reference/VBA/Conversion/Fix), [CInt](/en/official/Reference/VBA/Conversion/CInt), [CLng](/en/official/Reference/VBA/Conversion/CLng) functions
