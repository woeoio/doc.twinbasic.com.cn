...
::: info
The **Error** *function* (described here) and the [**Error**](/en/official/Reference/Core/Error) *statement* share a name but are different language elements. The function returns the message text for an error number; the statement raises a run-time error.
:::
...
- [CVErr](/en/official/Reference/VBA/Conversion/CVErr) function
