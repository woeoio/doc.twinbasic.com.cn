...
**UBound** is used together with [**LBound**](/en/official/Reference/VBA/Information/LBound) to determine the size of an array.
...
- [LBound](/en/official/Reference/VBA/Information/LBound) function
