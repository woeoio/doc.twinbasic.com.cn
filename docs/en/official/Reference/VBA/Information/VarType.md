...
Returns a [**VbVarType**](/en/official/Reference/VBA/Constants/VbVarType) value identifying the subtype of a variable, or the type of an object's default property.
...
The return value is one of the constants from the [**VbVarType**](/en/official/Reference/VBA/Constants/VbVarType) enumeration, or the sum of one of those constants and `vbArray`. The most useful values are:
...
- [TypeName](/en/official/Reference/VBA/Information/TypeName) function
- [VbVarType](/en/official/Reference/VBA/Constants/VbVarType) enumeration
