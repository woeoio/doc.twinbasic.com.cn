...
**LBound** is used together with [**UBound**](/en/official/Reference/VBA/Information/UBound) to determine the size of an array.
...
- [UBound](/en/official/Reference/VBA/Information/UBound) function
- [IsArray](/en/official/Reference/VBA/Information/IsArray), [IsArrayInitialized](/en/official/Reference/VBA/Information/IsArrayInitialized) functions
