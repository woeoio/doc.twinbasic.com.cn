...
Error values are produced by passing an error number through the [**CVErr**](/en/official/Reference/VBA/Conversion/CVErr) function. **IsError** returns **True** if *expression* indicates an error; otherwise, **False**.
...
- [Err](/en/official/Reference/VBA/Information/Err) property
