...
The *color* argument represents colour values used by earlier versions of Basic --- Microsoft Visual Basic for MS-DOS and the QuickBASIC compiler. Starting with the least-significant byte, the returned value specifies the red, green, and blue components used to set the corresponding colour in the RGB system, exactly as if [**RGB**](/en/official/Reference/VBA/Information/RGB) had been called with those components.
...
- [TranslateColor](/en/official/Reference/VBA/Information/TranslateColor) function
