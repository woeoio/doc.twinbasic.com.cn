...
The **NPV** function uses the order of values within the array to interpret the order of payments and receipts. The payment and receipt values must be in the correct sequence.
...
The **NPV** function is similar to the [**PV**](/en/official/Reference/VBA/Financial/PV) function (present value) except that the **PV** function allows cash flows to begin either at the end or the beginning of a period. Unlike the variable **NPV** cash flow values, **PV** cash flows must be fixed throughout the investment.
...
- [IRR](/en/official/Reference/VBA/Financial/IRR), [MIRR](/en/official/Reference/VBA/Financial/MIRR), [PV](/en/official/Reference/VBA/Financial/PV) functions
