...
Before calling **Rnd**, use the [**Randomize**](/en/official/Reference/VBA/Math/Randomize) statement without an argument to initialize the random-number generator with a seed based on the system timer.
...
- [Randomize](/en/official/Reference/VBA/Math/Randomize) statement
