...
::: info
**Atn** is the inverse trigonometric function of [**Tan**](/en/official/Reference/VBA/Math/Tan), which takes an angle as its argument and returns the ratio of two sides of a right triangle. Do not confuse **Atn** with the cotangent, which is the simple inverse of a tangent (1/tangent).
:::
...
- [Cos](/en/official/Reference/VBA/Math/Cos), [Sin](/en/official/Reference/VBA/Math/Sin), [Tan](/en/official/Reference/VBA/Math/Tan) functions
