...
The **Reset** statement closes all active files opened by the [Open](/en/official/Reference/Core/Open) statement and writes the contents of all file buffers to disk.
...
- [Close](/en/official/Reference/Core/Close) statement
