...
Record numbers specified in [Get](/en/official/Reference/Core/Get) and [Put](/en/official/Reference/Core/Put) statements override file positioning performed by **Seek**.
...
- [Loc](/en/official/Reference/VBA/FileSystem/Loc) function
- [LOF](/en/official/Reference/VBA/FileSystem/LOF) function
- [EOF](/en/official/Reference/VBA/FileSystem/EOF) function
