...
*compare*
: *optional* Specifies the type of string comparison. If the *compare* argument is **Null**, an error occurs. If *compare* is omitted, the [**Option Compare**](/en/official/Reference/Core/Option) setting determines the type of comparison.
