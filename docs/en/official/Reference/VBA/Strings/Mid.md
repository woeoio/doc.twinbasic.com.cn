...
::: tip
Use the [**Mid =**](/en/official/Reference/Core/Mid-equals) statement to replace characters within a string.
:::
...
- [Left](/en/official/Reference/VBA/Strings/Left), [Len](/en/official/Reference/VBA/Strings/Len), [Right](/en/official/Reference/VBA/Strings/Right) functions
- [Mid =](/en/official/Reference/Core/Mid-equals) statement
