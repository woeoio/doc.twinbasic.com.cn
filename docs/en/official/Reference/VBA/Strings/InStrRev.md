...
|------------------------|-------|------------------------------------------------------------------------------------------|
| **vbUseCompareOption** | -1    | Performs a comparison by using the setting of the [**Option Compare**](/en/official/Reference/Core/Option) statement. |
...
::: info
The syntax for the **InStrRev** function is not the same as the syntax for the [**InStr**](/en/official/Reference/VBA/Strings/InStr) function --- note the swapped order of the search arguments.
:::
...
- [InStr](/en/official/Reference/VBA/Strings/InStr) function
