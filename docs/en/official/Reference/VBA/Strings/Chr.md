...
The functions [**Asc**, **AscB**, and **AscW**](/en/official/Reference/VBA/Strings/Asc) are the opposite of **Chr**, **ChrB**, and **ChrW**. The **Asc** functions convert a string to an integer.
...
- [Asc](/en/official/Reference/VBA/Strings/Asc) function
