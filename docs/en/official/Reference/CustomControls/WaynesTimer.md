...
Which sides of the control are attached to its container during resize. [**Anchors**](/en/official/Reference/CustomControls/Styles/Anchors). Inherited. (Has no visual effect at run time since the control draws nothing then.)
...
The control's height in pixels. [**PixelCount**](/en/official/Reference/CustomControls/Enumerations/PixelCount). Inherited. Forced to 32 on initialize.
...
The control's width in pixels. [**PixelCount**](/en/official/Reference/CustomControls/Enumerations/PixelCount). Inherited. Forced to 32 on initialize.
