...
Each state is a [**WaynesButtonState**](/en/official/Reference/CustomControls/WaynesButton/WaynesButtonState) --- a small bundle of [**Corners**](/en/official/Reference/CustomControls/Styles/Corners), [**BackgroundFill**](/en/official/Reference/CustomControls/Styles/Fill), [**Borders**](/en/official/Reference/CustomControls/Styles/Borders), and [**TextRendering**](/en/official/Reference/CustomControls/Styles/TextRendering).
...
The [**WaynesButtonState**](/en/official/Reference/CustomControls/WaynesButton/WaynesButtonState) used when the control has the keyboard focus but is not being hovered or pressed.
...
The [**WaynesButtonState**](/en/official/Reference/CustomControls/WaynesButton/WaynesButtonState) used when the mouse is hovering over the button without being pressed (or when the mouse has been pressed and dragged off the button).
...
The [**WaynesButtonState**](/en/official/Reference/CustomControls/WaynesButton/WaynesButtonState) used when the button is idle --- not hovered, not focused, not pressed.

### PressedState

The [**WaynesButtonState**](/en/official/Reference/CustomControls/WaynesButton/WaynesButtonState) used when the mouse is held down on the button.
