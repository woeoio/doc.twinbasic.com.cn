...
---
# PointSize
A **Long**-compatible type alias for a font size, expressed in *typographic points* (a point is 1⁄72 of an inch). Used by [**FontStyle.Size**](/en/official/Reference/CustomControls/Styles/TextRendering#size). New [**FontStyle**](/en/official/Reference/CustomControls/Styles/TextRendering) objects default to 12 points.
