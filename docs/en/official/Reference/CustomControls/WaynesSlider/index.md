...
[**Value**](#value) is just a **Long** property --- assigning to it from outside the control moves the block and triggers a repaint. Combined with a [**WaynesTimer**](/en/official/Reference/CustomControls/WaynesTimer), the slider can animate itself across its range:
...
The [**WaynesSliderState**](/en/official/Reference/CustomControls/WaynesSlider/WaynesSliderState) used when the control has the keyboard focus and the mouse is not hovering.
...
The [**WaynesSliderState**](/en/official/Reference/CustomControls/WaynesSlider/WaynesSliderState) used when the mouse is hovering over the block or over the track.
...
The [**WaynesSliderState**](/en/official/Reference/CustomControls/WaynesSlider/WaynesSliderState) used when the slider is idle --- not hovered, not focused.
