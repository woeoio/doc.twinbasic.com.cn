...
Clipboard contents are tagged with a *format* --- text, bitmap, files, rich text, and so on. The [**ClipboardConstants**](/en/official/Reference/VBRUN/Constants/ClipboardConstants) enum lists the predefined formats:
...
*Format*
: *optional* A member of [**ClipboardConstants**](/en/official/Reference/VBRUN/Constants/ClipboardConstants) selecting which picture format to retrieve (**vbCFBitmap**, **vbCFDIB**, **vbCFMetafile**, **vbCFEMetafile**, or **vbCFPalette**). When omitted, the implementation picks the most descriptive format the clipboard currently holds.
...
*Format*
: *required* A member of [**ClipboardConstants**](/en/official/Reference/VBRUN/Constants/ClipboardConstants) --- the format to probe for.
...
*Format*
: *optional* A member of [**ClipboardConstants**](/en/official/Reference/VBRUN/Constants/ClipboardConstants) selecting which text format to retrieve: **vbCFText** (default), **vbCFUnicodeText**, **vbCFRTF**, or **vbCFLink**.
...
*Format*
: *optional* A member of [**ClipboardConstants**](/en/official/Reference/VBRUN/Constants/ClipboardConstants) --- which picture format to publish. When omitted, the format is inferred from the picture's underlying type.
...
*Format*
: *optional* A member of [**ClipboardConstants**](/en/official/Reference/VBRUN/Constants/ClipboardConstants) --- **vbCFText** (default), **vbCFUnicodeText**, **vbCFRTF**, or **vbCFLink**.
