...
*ColorDepth*
: *optional* A member of [**LoadPictureColorConstants**](/en/official/Reference/VBRUN/Constants/LoadPictureColorConstants) --- meaningful only for icons and cursors, where it picks among the colour depths stored in the file.
...
*restype*
: *required* A member of [**LoadResConstants**](/en/official/Reference/VBRUN/Constants/LoadResConstants) --- **vbResBitmap**, **vbResIcon**, or **vbResCursor**.
