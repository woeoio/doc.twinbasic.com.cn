...
How the glyph is shaded when [**VisualStyles**](#visualstyles) is **False**. A member of [**AppearanceConstants**](/en/official/Reference/VBRUN/Constants/AppearanceConstants): **vbAppear3d** (default) or **vbAppearFlat**. Ignored when [**VisualStyles**](#visualstyles) is **True**.
...
A read-only [**ControlTypeConstants**](/en/official/Reference/VBRUN/Constants/ControlTypeConstants) value identifying this control as a check mark. Always **vbCheckMark**.
...
*value*
: A member of [**CheckBoxConstants**](/en/official/Reference/VBRUN/Constants/CheckBoxConstants): **vbUnchecked** (0), **vbChecked** (1), or **vbGrayed** (2).
