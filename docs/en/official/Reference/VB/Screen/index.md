...
The application-wide mouse-pointer override, as a member of [**MousePointerConstants**](/en/official/Reference/VBRUN/Constants/MousePointerConstants). **Integer**, readable and writable.
