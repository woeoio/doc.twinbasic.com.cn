...
The IDE's DEBUG CONSOLE pane --- reached through [**Host.DebugConsole**](/en/official/Reference/tbIDE/Host#debugconsole). The canonical place for an addin to write diagnostic and log output.
