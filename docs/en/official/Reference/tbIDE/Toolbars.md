...
The collection of IDE toolbars. Reached through [**Host.Toolbars**](/en/official/Reference/tbIDE/Host#toolbars). Currently a single toolbar --- `Host.Toolbars(0)` --- but the collection interface allows future IDE versions to add more.
...
Syntax: *toolbars*( *Index* ) **As** [**Toolbar**](/en/official/Reference/tbIDE/Toolbar)
