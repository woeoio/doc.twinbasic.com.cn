...
The IDE's active-theme state --- reached through [**Host.Themes**](/en/official/Reference/tbIDE/Host#themes). Pair with the [**Host.OnChangedTheme**](/en/official/Reference/tbIDE/Host#onchangedtheme) event to refresh any colour-sensitive elements the addin draws inside its tool windows.
