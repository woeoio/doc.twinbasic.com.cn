...
The value accumulates across successive **AsyncReadProgress** notifications and reaches its final total by the time **AsyncReadComplete** fires. When [**BytesMax**](/en/official/Reference/VBRUN/AsyncProperty/BytesMax) is non-zero, the ratio `BytesRead / BytesMax` gives the fraction of the read that has completed.
...
- [StatusCode](/en/official/Reference/VBRUN/AsyncProperty/StatusCode) property
