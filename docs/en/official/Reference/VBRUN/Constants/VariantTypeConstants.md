...
Legacy DAO field-type tags, retained for compatibility with very early Visual Basic / DAO code. New code should use the matching values in [**VbVarType**](/en/official/Reference/VBA/Constants/VbVarType).
