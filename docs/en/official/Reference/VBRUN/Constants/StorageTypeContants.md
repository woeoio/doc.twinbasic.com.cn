...
OLE data-storage medium identifiers used by [**DataObjectFormat.StorageType**](/en/official/Reference/VBRUN/DataObject/DataObjectFormat#storagetype) and other low-level data-transfer routines, identifying how the bytes are physically stored.
