...
The kind of data being delivered by **UserControl.AsyncRead**, also reported back through [**AsyncProperty.AsyncType**](/en/official/Reference/VBRUN/AsyncProperty/AsyncType).
