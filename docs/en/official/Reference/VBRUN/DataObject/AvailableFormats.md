...
Returns a [**DataObjectFormats**](/en/official/Reference/VBRUN/DataObject/DataObjectFormats) collection describing every format the **DataObject** currently holds a value in.
