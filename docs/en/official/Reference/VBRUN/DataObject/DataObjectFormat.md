...
Examples: `vbCFText`, `vbCFUnicodeText`, `vbCFBitmap`, `vbCFFiles`. The same numeric identifier can be passed to [**GetData**](/en/official/Reference/VBRUN/DataObject/GetData) or [**GetFormat**](/en/official/Reference/VBRUN/DataObject/GetFormat).
...
- [DataObjectFormats](/en/official/Reference/VBRUN/DataObject/DataObjectFormats) collection
