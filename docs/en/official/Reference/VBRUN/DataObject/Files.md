...
Returns a [**DataObjectFiles**](/en/official/Reference/VBRUN/DataObject/DataObjectFiles) collection holding the file paths the **DataObject** contains.
...
The source side may also fill the **DataObject** with a list of files by adding paths to this collection --- see [**DataObjectFiles.Add**](/en/official/Reference/VBRUN/DataObject/DataObjectFiles#add).
...
- [DataObjectFiles](/en/official/Reference/VBRUN/DataObject/DataObjectFiles) collection
