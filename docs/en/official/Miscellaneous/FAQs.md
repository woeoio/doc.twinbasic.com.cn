...
![img](Images/16833fae-4bd7-418f-bb16-691a611a5b01.png){style="width:50%; height:auto;"}</details>
...
::: info
This will not be set as the icon of any form; icons for forms are set by the "Icon" property in the Properties list.
:::
