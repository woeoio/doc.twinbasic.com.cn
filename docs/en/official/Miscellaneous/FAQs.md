...
::: details Where can I get twinBASIC?
...
::: details What is the current status of the project?
...
::: details Is there an estimated timeline for when expected features will become available?
...
::: details What new features does twinBASIC have compared to VB6?

**Many!** It has 64bit compilation (using VBA7x64 compatible syntax), generics, overloading, multithreading (API-only right now, built in syntax coming soon), inheritance, ability to define interfaces and coclasses in your project using BASIC-style syntax, Unicode support in all controls and the editor (.twin files only), support for modern image formats, numerous enhancements to _Implements_, ability to create standard DLLs and kernel mode drivers, ability to set UDT packing alignment, and dozens of others, all available _right now_, with many more planned in the future.

For a full list of all the new features available right now, see the Wiki article [Overview of features new to twinBASIC](/en/official/Features/).

:::

::: details Where can I learn more about twinBASIC, find documentation, and participate in the community?
...
::: details Is twinBASIC Open Source?
...
::: details How much does twinBASIC cost?
...
**Note:** You can change the subscription level at any time and the community edition is always available. There will be no lockout (see [the previous statement regarding escrow](#open-source)) so you will always have the ability to develop, test and compile.

:::

::: details Can I pay a one-time fee for a perpetual license?
...
::: details Can twinBASIC be used to develop commercial products, and what royalties are owed?
...
::: details What does '100% backwards compatible' mean, technically?
...
::: details So some of my projects won't work?
...
::: details How do I report bugs or other problems?
...
::: details Is the twinBASIC IDE available in other languages?
...
::: details What are the system requirements for twinBASIC?
...
::: details twinBASIC won't run; says there's an invalid entry point.
...
::: details The IDE reports missing files when I try to launch it.
...
::: details How do I install twinBASIC?
...
::: details Is twinBASIC safe? (Some scanner) says it's malicious.
...
::: details How do I import my VB6 project into twinBASIC?
...
::: details Why do I see a lot of errors saying my variables are unrecognized?
...
::: details Does twinBASIC support addins?
...
::: details How do I use resources in twinBASIC?
...
**Note:** This will not be set as the icon of any form; icons for forms are set by the "Icon" property in the Properties list.
...
::: details What are the runtime requirements for twinBASIC-produced EXEs/binaries?
...
::: details Why are EXEs produced by twinBASIC larger than VB6?
