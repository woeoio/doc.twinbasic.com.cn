...
For more information on Control Anchoring and Control Docking, see the [Anchoring and Docking page](/en/official/Features/GUI-Components/Anchoring-Docking).
