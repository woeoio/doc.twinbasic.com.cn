...
This is primarily used to create Standard DLLs (see [Project Types](/en/official/Features/Project-Configuration/Project-Types)), but this functionality is also available in Standard EXE and other compiled project types.
