...
For design rationale and narrative descriptions, see [tbdocs Builder](/en/official/Documentation/Builder). To add a new stage or markdown-it plugin, see [Extending the Builder](/en/official/Documentation/Extending).
...
- [tbdocs Builder](/en/official/Documentation/Builder) -- architecture overview and narrative design rationale.
