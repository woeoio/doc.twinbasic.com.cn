...
- [Book Configuration](/en/official/Documentation/Book-Configuration) -- the `_book.yml` manifest that controls what goes into `book.html`.
- [Pipeline Stages](/en/official/Documentation/Pipeline-Stages) -- the `pdf.mjs` and `book.mjs` interface contracts for Phase 8.
- [tbdocs Builder](/en/official/Documentation/Builder) -- design rationale for Phase 8 in the tbdocs pipeline.
