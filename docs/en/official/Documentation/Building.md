...
The full set of `tbdocs` CLI flags --- every flag, what each one does, when to use it --- lives on the [Tools and Scripts](/en/official/Documentation/Tools#tbdocs) page.
