...
The [**WebView2**](../../Reference/WebView2/) control hosts the Microsoft Edge browser engine inside a twinBASIC form --- navigate to web pages, run local web apps, exchange messages and method calls with JavaScript, intercept HTTP traffic, and print pages to PDF.
...
- [Customize the UserDataFolder](Customize-the-UserDataFolder) -- relocating the runtime's working folder for hosted scenarios (Office add-ins, kiosk installs).
...
For the full set of members on the control itself, see the [**WebView2** class reference](../../Reference/WebView2/).
