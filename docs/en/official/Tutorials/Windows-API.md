...
> [!NOTE]
> In VBA-compatible code you can also read the last Win32 error through [**Err.LastDllError**](/Reference/VBA/Modules/Information/Err), which is populated automatically after any DLL call. Both return the same value; `Err.LastDllError` does not require an extra Declare.
