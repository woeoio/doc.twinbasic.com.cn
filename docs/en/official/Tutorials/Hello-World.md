...
[**MsgBox**](/Reference/VBA/Modules/Interaction/MsgBox) displays a standard Windows message box with the text you pass to it. It pauses execution until the user dismisses the dialog.
...
**MsgBox** is a function from the [VBA runtime library](/Reference/VBA/Modules/Interaction/MsgBox), which is part of every twinBASIC project by default. It wraps the Win32 `MessageBox` API and handles the dialog lifecycle for you.
