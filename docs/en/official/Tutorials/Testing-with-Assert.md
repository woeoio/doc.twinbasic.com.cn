...
The [Assert package](/Reference/Assert/) provides three modules --- [**Exact**](/Reference/Assert/Exact), [**Strict**](/Reference/Assert/Strict), and [**Permissive**](/Reference/Assert/Permissive) --- that share the same fifteen-member API:
...
- [Exact module](/Reference/Assert/Exact) -- strictest semantics
- [Strict module](/Reference/Assert/Strict) -- case-sensitive strings, type-lenient numeric
- [Permissive module](/Reference/Assert/Permissive) -- case-insensitive strings, type-lenient numeric
...
- **Assert package reference** -- all fifteen members in detail: [Assert package](/Reference/Assert/)
