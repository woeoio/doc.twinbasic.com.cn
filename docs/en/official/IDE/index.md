...
The [**tbForm**](Project/Editor/Form) and [**tbReport**](Project/Editor/Report) designers open when a form or report file is selected in the Project Explorer. Third-party and community addins extend the IDE with additional commands and tool windows.
