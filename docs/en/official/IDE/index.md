...
The IDE consists of several fixed panes and tool windows. The [**Project Explorer**](/en/official/IDE/Project-Explorer) shows the file tree of the open project; the [**Editor**](/en/official/IDE/Editor) is the main code and designer surface; the [**Properties**](/en/official/IDE/Properties) pane shows and edits properties for the selected item; the [**Toolbox**](/en/official/IDE/Toolbox) lists the controls available to drop onto a form.
