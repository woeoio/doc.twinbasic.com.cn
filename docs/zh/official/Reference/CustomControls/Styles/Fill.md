...
For three or more colour stops, build [**FillColorPoint**](#fillcolorpoint-class) instances and pass them to [**SetColorPoints**](#setcolorpoints). The stops accept fully-opaque ARGB literals (`&HFF` alpha in the high byte) --- see [**ColorRGBA**](/official/Reference/CustomControls/Enumerations/ColorRGBA) for the encoding:
...
How the colours in [**ColorPoints**](#colorpoints) are mapped across the region. A member of [**FillPattern**](/official/Reference/CustomControls/Enumerations/FillPattern). Default: **tbGradientNorthToSouth**. Use **tbPatternNone** to make the **Fill** transparent.
...
*Pattern*
: *optional* A member of [**FillPattern**](/official/Reference/CustomControls/Enumerations/FillPattern). Default: **tbGradientNorthToSouth**.

### SetSimplePatternRGBA

Same as [**SetSimplePattern**](#setsimplepattern) but accepts raw 32-bit [**ColorRGBA**](/official/Reference/CustomControls/Enumerations/ColorRGBA) values with their own alpha channels rather than three-byte RGB colours.

Syntax: *object*.**SetSimplePatternRGBA** *Value1RGBA*, *Value2RGBA* [, *Granularity* [, *Pattern* ] ]

*Value1RGBA*
: *required* A [**ColorRGBA**](/official/Reference/CustomControls/Enumerations/ColorRGBA) (ABGR) value for the first gradient stop.

*Value2RGBA*
: *required* A [**ColorRGBA**](/official/Reference/CustomControls/Enumerations/ColorRGBA) (ABGR) value for the second gradient stop.
...
*ValueRGBA*
: *required* A [**ColorRGBA**](/official/Reference/CustomControls/Enumerations/ColorRGBA) (ABGR) value.
...
The stop's colour as a 32-bit ABGR value. [**ColorRGBA**](/official/Reference/CustomControls/Enumerations/ColorRGBA).
...
*ColorRGBA*
: *optional* A [**ColorRGBA**](/official/Reference/CustomControls/Enumerations/ColorRGBA) value to assign to [**Color**](#color).
