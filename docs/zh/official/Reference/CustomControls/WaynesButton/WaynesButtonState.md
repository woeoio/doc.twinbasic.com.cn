...
The [**Fill**](/official/Reference/CustomControls/Styles/Fill) that paints the button's background.

### Borders

The [**Borders**](/official/Reference/CustomControls/Styles/Borders) that draws the button's border strokes.

### Corners

The [**Corners**](/official/Reference/CustomControls/Styles/Corners) that controls the per-corner shape and radius.

### TextRendering

The [**TextRendering**](/official/Reference/CustomControls/Styles/TextRendering) that controls how the button's [**Caption**](/official/Reference/CustomControls/WaynesButton/#caption) is drawn.
...
Raised whenever any of the four contained style objects raises its own **OnChanged**. The parent [**WaynesButton**](/official/Reference/CustomControls/WaynesButton/) listens for this and requests a repaint.
