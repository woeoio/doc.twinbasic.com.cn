...
| **tbAlignMiddleCenter** | 4 | Vertically centred, horizontally centred. The default for newly-constructed [**TextRendering**](/official/Reference/CustomControls/Styles/TextRendering) objects. |
...
The padding added around the text by [**TextRendering.Padding**](/official/Reference/CustomControls/Styles/TextRendering#padding) is applied first; the alignment then positions the text inside the padded region.
