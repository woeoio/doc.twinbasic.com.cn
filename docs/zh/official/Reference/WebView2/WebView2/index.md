...
Always **vbWebView2** ([**ControlTypeConstants**](/official/Reference/VBRUN/Constants/ControlTypeConstants)). Read-only. Inherited.
...
How drag-and-drop is initiated. A member of [**DragModeConstants**](/official/Reference/VBRUN/Constants/DragModeConstants): **vbManual** (0, default --- call [**Drag**](#drag) from code) or **vbAutomatic** (1). Inherited.
...
The [**WebView2EnvironmentOptions**](/official/Reference/WebView2/WebView2/EnvironmentOptions) object that configures the WebView2 environment --- user-data folder, executable folder, locale, tracking-prevention, single-sign-on, and additional command-line arguments. The control auto-creates one on initialization; assign to its fields before or during the [**Create**](#create) event for them to take effect.
...
The mouse cursor over the control. A member of [**MousePointerConstants**](/official/Reference/VBRUN/Constants/MousePointerConstants). Inherited.
...
Calls into the host object are asynchronous on the JavaScript side and must be `await`-ed inside an `async` function --- even when *UseDeferredInvoke* is **False**. See the [Re-entrancy](/official/Tutorials/WebView2/Re-entrancy) tutorial for when to pass **True**.
...
*FilterContext*
: *required* A member of [**wv2WebResourceContext**](/official/Reference/WebView2/Enumerations/wv2WebResourceContext) restricting matches to a particular resource kind.
...
*Orientation*
: *optional* A member of [**wv2PrintOrientation**](/official/Reference/WebView2/Enumerations/wv2PrintOrientation). Default **wv2PrintPortrait**.
...
*FilterContext*
: *required* A member of [**wv2WebResourceContext**](/official/Reference/WebView2/Enumerations/wv2WebResourceContext).
...
*accessKind*
: *optional* A member of [**wv2HostResourceAccessKind**](/official/Reference/WebView2/Enumerations/wv2HostResourceAccessKind). Default **wv2ResourceAllow**.
...
See the [Hosting local web assets](/official/Tutorials/WebView2/Hosting-local-web-assets) tutorial for the matching pattern of bundling the assets through the project's `Resources` folder.
...
Syntax: *object*\_**AcceleratorKeyPressed**( *KeyState* **As** [**wv2KeyEventKind**](/official/Reference/WebView2/Enumerations/wv2KeyEventKind), *IsExtendedKey* **As Boolean**, *WasKeyDown* **As Boolean**, *IsKeyReleased* **As Boolean**, *IsMenuKeyDown* **As Boolean**, *RepeatCount* **As Long**, *ScanCode* **As Long**, *IsHandled* **As Boolean** )

The flags are the contents of the Win32 `WM_KEYDOWN` / `WM_KEYUP` *lParam* --- see [**COREWEBVIEW2_PHYSICAL_KEY_STATUS**](/official/Reference/WebView2/Types/COREWEBVIEW2_PHYSICAL_KEY_STATUS) for the full breakdown.
...
Raised after a navigation finishes --- successfully or otherwise. Inspect *IsSuccess* first; if **False**, *WebErrorStatus* is a member of [**wv2ErrorStatus**](/official/Reference/WebView2/Enumerations/wv2ErrorStatus).
...
Syntax: *object*\_**NavigationStarting**( *Uri* **As String**, *IsUserInitiated* **As Boolean**, *IsRedirected* **As Boolean**, *RequestHeaders* **As** [**WebView2RequestHeaders**](/official/Reference/WebView2/WebView2RequestHeaders), *Cancel* **As Boolean** )
...
Raised when the page asks for permission to use a device or browser capability --- camera, microphone, geolocation, notifications, clipboard. Assign *State* to grant ([**wv2StateAllow**](/official/Reference/WebView2/Enumerations/wv2PermissionState#wv2StateAllow)) or deny ([**wv2StateDeny**](/official/Reference/WebView2/Enumerations/wv2PermissionState#wv2StateDeny)); leave it at **wv2StateDefault** to let Edge prompt the user. Can be deferred --- see [Deferred events](#deferred-events).

Syntax: *object*\_**PermissionRequested**( *IsUserInitiated* **As Boolean**, *State* **As** [**wv2PermissionState**](/official/Reference/WebView2/Enumerations/wv2PermissionState), *Uri* **As String**, *PermissionKind* **As** [**wv2PermissionKind**](/official/Reference/WebView2/Enumerations/wv2PermissionKind) )
...
Raised when one of WebView2's external processes (the browser, renderer, GPU, …) exits unexpectedly. Inspect *Kind* --- a [**wv2ProcessFailedKind**](/official/Reference/WebView2/Enumerations/wv2ProcessFailedKind) --- to find out which.

Syntax: *object*\_**ProcessFailed**( *Kind* **As** [**wv2ProcessFailedKind**](/official/Reference/WebView2/Enumerations/wv2ProcessFailedKind) )
...
Syntax: *object*\_**ScriptDialogOpening**( *ScriptDialogKind* **As** [**wv2ScriptDialogKind**](/official/Reference/WebView2/Enumerations/wv2ScriptDialogKind), *Accept* **As Boolean**, *ResultText* **As String**, *URI* **As String**, *Message* **As String**, *DefaultText* **As String** )
...
Syntax: *object*\_**WebResourceRequested**( *Request* **As** [**WebView2Request**](/official/Reference/WebView2/WebView2Request), *Response* **As** [**WebView2Response**](/official/Reference/WebView2/WebView2Response) )

## See Also

- [WebView2EnvironmentOptions](/official/Reference/WebView2/WebView2/EnvironmentOptions) -- pre-creation environment configuration reached via [**EnvironmentOptions**](#environmentoptions)
- [WebView2 tutorials](/official/Tutorials/WebView2/) -- installation, re-entrancy, and `UserDataFolder` worked examples
- [vbWebView2](/official/Reference/VBRUN/Constants/ControlTypeConstants#vbWebView2) -- the **ControlTypeConstants** entry returned by [**ControlType**](#controltype)
