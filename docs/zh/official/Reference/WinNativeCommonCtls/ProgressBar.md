...
::: info
The OS visual styles theme typically overrides this value in standard rendering. To see the assigned **ForeColor** at run time, disable visual styles by setting [**VisualStyles**](/official/Reference/VB/CheckBox/#visualstyles) to **False**.
:::
...
- [Slider](/official/Reference/WinNativeCommonCtls/Slider) -- when the user needs to set a value within a range, not just see progress
- [ControlTypeConstants](/official/Reference/VBRUN/Constants/ControlTypeConstants) -- where **vbProgressBar** lives
