...
The base interface for everything inside the IDE's virtual file system. Both [**File**](/official/Reference/tbIDE/File) and [**Folder**](/official/Reference/tbIDE/Folder) extend **FileSystemItem** and inherit its four universal members ([**Name**](#name), [**Path**](#path), [**Type**](#type), [**Parent**](#parent)). An item returned from a [**Folder**](/official/Reference/tbIDE/Folder) enumeration or from [**FileSystem.ResolvePath**](/official/Reference/tbIDE/FileSystem#resolvepath) is normally castable to its specific kind --- the [**Type**](#type) property or `TypeOf` discriminates between them.
...
The folder that contains this item. **As** [**Folder**](/official/Reference/tbIDE/Folder). Read-only. The root folder's **Parent** is **Nothing**.

### Path

The item's full virtual-FS path --- e.g. `"twinbasic:/Sources/MainModule.twin"`. **String**, read-only. Suitable as the *Path* argument to [**Editors.Open**](/official/Reference/tbIDE/Editors#open) and [**FileSystem.ResolvePath**](/official/Reference/tbIDE/FileSystem#resolvepath).
...
| **FileOTHER**            | 2 | A file the IDE recognises as binary or whose encoding it cannot determine. [**File.ReadText**](/official/Reference/tbIDE/File#readtext) is not supported on this kind. |
