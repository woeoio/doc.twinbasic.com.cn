...
Adds a new button to the right-hand end of the toolbar and returns the [**Button**](/official/Reference/tbIDE/Button) object for the addin to attach `WithEvents` against.

Syntax: *toolbar*.**AddButton**( *Id*, *Caption* [, *IconData* ] ) **As** [**Button**](/official/Reference/tbIDE/Button)
