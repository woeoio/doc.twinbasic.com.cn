...
- [**Categories**](/official/Reference/Categories) -- statements, procedures, and functions grouped by purpose (declarations, control flow, string handling, file I/O, …)
...
- [**Enumerations**](/official/Reference/Enumerations) -- index of all 141 enumeration types across all twelve packages, grouped by package and A--Z
- [**Data Types**](/official/Reference/Data-Types) -- storage size, range, and suffix for every intrinsic type (**Boolean** through **Variant**)
- [**Compiler Constants**](/official/Reference/Compiler-Constants) -- the `#If` symbols the compiler recognises
- [**Attributes**](/official/Reference/Attributes) -- `[Documentation(...)]`, `[COMCreatable(...)]`, and the rest of the attribute syntax
- [**twinBASIC Additions**](/official/Reference/twinBASIC-Additions) -- curated list of language and runtime additions beyond standard VBA

**Controls and glossary:**

- [**Controls**](/official/Reference/Controls) -- the standard UI controls grouped by purpose
- [**Glossary**](/official/Reference/Glossary) -- technical terms used across the docs

**Packages:**

- [**Packages**](/official/Reference/Packages) -- all twelve built-in packages: the default runtime trio (VBA, VBRUN, VB), the GUI extensions (CustomControls, WinNativeCommonCtls), the browser embeds (WebView2, CEF), the Windows-integration libraries (WinServicesLib, WinEventLogLib, WinNamedPipesLib), and the tooling packages (Assert, tbIDE)
