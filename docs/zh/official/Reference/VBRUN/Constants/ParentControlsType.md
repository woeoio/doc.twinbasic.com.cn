...
Wrapping mode for the [**ParentControls**](/official/Reference/VBRUN/ParentControls/) collection, controlling whether each item is returned wrapped in its host **Extender** or as the bare control.
...
- [ParentControls](/official/Reference/VBRUN/ParentControls/) module
