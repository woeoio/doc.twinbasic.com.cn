...
The functions [**Asc**, **AscB**, and **AscW**](/official/Reference/VBA/Strings/Asc) are the opposite of **Chr**, **ChrB**, and **ChrW**. The **Asc** functions convert a string to an integer.
...
- [Asc](/official/Reference/VBA/Strings/Asc) function
