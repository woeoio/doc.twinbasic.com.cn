...
The functions [**Chr**, **ChrB**, and **ChrW**](/official/Reference/VBA/Strings/Chr) are the opposite of **Asc**, **AscB**, and **AscW**. The **Chr** functions convert an integer to a character string.
...
- [Chr](/official/Reference/VBA/Strings/Chr) function
