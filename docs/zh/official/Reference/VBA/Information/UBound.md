...
**UBound** is used together with [**LBound**](/official/Reference/VBA/Information/LBound) to determine the size of an array.
...
- [LBound](/official/Reference/VBA/Information/LBound) function
