...
The **Calendar** property can only be set programmatically. The setting of **Calendar** affects the string returned by the [**Date$**](/official/Reference/VBA/DateTime/Date#date-1) property when the calendar is set to Hijri.
...
- [Date](/official/Reference/VBA/DateTime/Date) property
