...
If the [**Calendar**](/official/Reference/VBA/DateTime/Calendar) property setting is Gregorian, the supplied value is assumed to be Gregorian. If the setting is Hijri, the supplied value is assumed to be Hijri, and two-digit *year* values between 0 and 99 are interpreted as the years 1400--1499.
...
- [DateValue](/official/Reference/VBA/DateTime/DateValue), [Day](/official/Reference/VBA/DateTime/Day), [Month](/official/Reference/VBA/DateTime/Month), [Year](/official/Reference/VBA/DateTime/Year) functions
