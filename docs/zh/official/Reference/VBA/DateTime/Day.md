...
::: info
If the [**Calendar**](/official/Reference/VBA/DateTime/Calendar) property setting is Gregorian, the returned integer represents the Gregorian day of the month. If the calendar is Hijri, the returned integer represents the Hijri day of the month.
:::
...
- [Month](/official/Reference/VBA/DateTime/Month), [Year](/official/Reference/VBA/DateTime/Year), [DatePart](/official/Reference/VBA/DateTime/DatePart) functions
