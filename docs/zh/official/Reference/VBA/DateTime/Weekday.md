...
If the [**Calendar**](/official/Reference/VBA/DateTime/Calendar) property setting is Gregorian, the returned integer represents the Gregorian day of the week for the date argument. If the calendar is Hijri, the returned integer represents the Hijri day of the week for the date argument.
...
- [Day](/official/Reference/VBA/DateTime/Day), [Month](/official/Reference/VBA/DateTime/Month), [Year](/official/Reference/VBA/DateTime/Year) functions
