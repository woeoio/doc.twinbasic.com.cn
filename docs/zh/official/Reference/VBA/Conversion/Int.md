...
::: info
The closely related [**Fix**](/official/Reference/VBA/Conversion/Fix) function truncates toward zero rather than rounding toward negative infinity. For positive numbers the two are identical; for negative numbers they differ.
:::
...
- [Fix](/official/Reference/VBA/Conversion/Fix), [CInt](/official/Reference/VBA/Conversion/CInt), [CLng](/official/Reference/VBA/Conversion/CLng) functions
