...
Releases a block of memory previously obtained from [**AllocMem**](/official/Reference/VBA/HiddenModule/AllocMem).

Syntax: **FreeMem** *MemPointer*

*MemPointer*
: *required* **LongPtr**. The address returned by a previous call to [**AllocMem**](/official/Reference/VBA/HiddenModule/AllocMem).
...
- [AllocMem](/official/Reference/VBA/HiddenModule/AllocMem) function
