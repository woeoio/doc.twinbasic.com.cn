...
*windowstyle*
: *optional* A [**VbAppWinStyle**](/official/Reference/VBA/Constants/VbAppWinStyle) value specifying the style of window in which the program is run. If omitted, the program is started minimized with focus (`vbMinimizedFocus`).
...
- [VbAppWinStyle](/official/Reference/VBA/Constants/VbAppWinStyle) enumeration
