...
::: info
The array-based variant of this function --- [**RaiseEventByName**](/official/Reference/VBA/Interaction/RaiseEventByName) --- takes the argument list as a single packed **Variant** array, which is more convenient when the argument list is itself constructed dynamically. Use **RaiseEventByName2** when the argument list is fixed at the call site.
:::
...
- [RaiseEventByName](/official/Reference/VBA/Interaction/RaiseEventByName) function
