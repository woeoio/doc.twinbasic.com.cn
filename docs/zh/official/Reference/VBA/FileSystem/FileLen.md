...
::: info
Use the [LOF](/official/Reference/VBA/FileSystem/LOF) function to obtain the length of an open file.
:::
...
- [FileDateTime](/official/Reference/VBA/FileSystem/FileDateTime) function
