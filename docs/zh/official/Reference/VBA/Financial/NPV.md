...
The **NPV** function is similar to the [**PV**](/official/Reference/VBA/Financial/PV) function (present value) except that the **PV** function allows cash flows to begin either at the end or the beginning of a period. Unlike the variable **NPV** cash flow values, **PV** cash flows must be fixed throughout the investment.
...
- [IRR](/official/Reference/VBA/Financial/IRR), [MIRR](/official/Reference/VBA/Financial/MIRR), [PV](/official/Reference/VBA/Financial/PV) functions
