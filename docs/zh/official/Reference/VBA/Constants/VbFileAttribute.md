...
Attribute flags for files and directories used by [**Dir**](/official/Reference/VBA/FileSystem/Dir), [**GetAttr**](/official/Reference/VBA/FileSystem/GetAttr), and [**SetAttr**](/official/Reference/VBA/FileSystem/SetAttr). Combine multiple flags with **Or**.
