...
The value is the GUID assigned to the enclosing class by its [`[ClassId(...)]`](/official/Reference/Core/Attributes#classid) attribute. If no **ClassId** is set, the function returns the all-zero GUID.
...
- [ClassId](/official/Reference/Core/Attributes#classid) attribute
