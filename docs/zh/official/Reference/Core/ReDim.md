...
The **ReDim** statement is used to size or resize a dynamic array that has already been formally declared by using a [**Private**](/official/Reference/Core/Private), [**Public**](/official/Reference/Core/Public), or [**Dim**](/official/Reference/Core/Dim) statement with empty parentheses (without dimension subscripts).
...
A variable that refers to an object must be assigned an existing object by using the [**Set**](/official/Reference/Core/Set) statement before it can be used. Until it is assigned an object, the declared object variable has the special value **Nothing**, which indicates that it doesn't refer to any particular instance of an object.
...
- [**Erase** statement](/official/Reference/Core/Erase)
