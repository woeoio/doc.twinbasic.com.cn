...
Any number of [**Exit While**](/official/Reference/Core/Exit) statements may be placed anywhere in the **While...Wend** loop as a way to exit early. **Exit While** is often used after evaluating some condition, in which case it transfers control to the statement immediately following the **Wend**.

Any number of [**Continue While**](/official/Reference/Core/Continue) statements may be placed anywhere in the **While...Wend** loop to skip the rest of the statements and proceed with a new iteration.
...
::: tip
The [**Do...Loop**](/official/Reference/Core/Do-Loop) statement provides a more structured and flexible way to perform looping.
:::
...
- [**For...Next** statement](/official/Reference/Core/For-Next)
