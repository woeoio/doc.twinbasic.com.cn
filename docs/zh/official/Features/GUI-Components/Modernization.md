...
The best option is Krool's VBCCR and VBFlexGrid projects. These are now available [from the Package Server](/official/Features/Packages/Importing-a-package-from-TWINSERV) in x64-compatible form, and are also DPI aware and support Visual Styles.
