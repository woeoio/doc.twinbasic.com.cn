...
- [CustomControls package reference](/official/Reference/CustomControls/) -- the full reference for the built-in `Waynes…` controls and the framework they are built on, including [`ICustomControl`](/official/Reference/CustomControls/Framework/ICustomControl), [`Canvas`](/official/Reference/CustomControls/Framework/Canvas), and the style helpers ([`Fill`](/official/Reference/CustomControls/Styles/Fill), [`Corners`](/official/Reference/CustomControls/Styles/Corners), [`Borders`](/official/Reference/CustomControls/Styles/Borders), [`TextRendering`](/official/Reference/CustomControls/Styles/TextRendering), …)
