...
![面板布局菜单](Images/Menu_Window_PanelLayouts.png "面板布局菜单")
...
![管理面板布局 - 默认](Images/Menu_Window_PanelLayouts_ManagePanelLayouts_Default.png "管理面板布局 - 默认")
...
![管理面板布局 - 全屏](Images/Menu_Window_PanelLayouts_ManagePanelLayouts_Fullscreen.png "管理面板布局 - 全屏")
...
![面板特性菜单](Images/Menu_Window_PanelFeatures.png "面板特性菜单")
...
![键盘快捷键菜单](Images/Menu_Window_KeyboardShortcuts.png "键盘快捷键菜单")
...
![管理键盘快捷键](Images/Menu_Window_KeyboardShortcuts_ManageKeyboardShortcuts.png "管理键盘快捷键")

![管理键盘快捷键](Images/Menu_Window_KeyboardShortcuts_ManageKeyboardShortcuts_1.png "管理键盘快捷键")
...
![主题菜单](Images/Menu_Window_Theme.png "主题菜单")
...
![语言菜单](Images/Menu_Window_Language.png "语言菜单")
