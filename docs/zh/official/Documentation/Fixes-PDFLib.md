...
- [Paged.js Patches](/official/Documentation/Fixes-PagedJS) -- patches to the vendored paged.js bundle.
- [PDF Generation](/official/Documentation/PDF-Generation) -- how these shims fit into the three-phase render pipeline and the overall data flow.
