...
- [pdf-lib Patches](/official/Documentation/Fixes-PDFLib) -- the pdf-lib shims applied during the process phase.
- [PDF Generation](/official/Documentation/PDF-Generation) -- how the paged.js bundle fits into the three-phase render pipeline.
